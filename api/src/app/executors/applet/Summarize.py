...
class Summarize:
    ...
    def execute(self,filepath,document_array,is_document_uploaded, params):
        ...
        llm=LlmProvider.get_llm(class_name= self.get_class_name(),model_type=model_type, is_private=False, use_chat_model=False, max_output_token=1000, increase_model_token_limit=False)
