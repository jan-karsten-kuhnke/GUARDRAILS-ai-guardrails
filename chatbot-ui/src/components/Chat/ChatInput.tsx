...
export const ChatInput = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`px-3 pt-2 pb-3 text-center text-[12px] md:px-4 md:pt-3 md:pb-6 ${theme.textColorSecondary}`}
      >
        {applicationName}
        <Chip
          label="Beta"
        ...
        />
        lets your organisation use public LLM models in a safe and secure way,
        ensuring your corporate confidential information remains protected.
      </div>
    </div>
  );
};
