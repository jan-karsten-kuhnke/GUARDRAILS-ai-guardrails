...
const theme = createTheme({
  palette: {
    primary: {
      main: styles.primaryColor, // Change this to your desired primary color
    },
  },
});
...
export const CustomDataGrid = (props: CustomDataGridProps) => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (props.onGridDataUpdate) props.onGridDataUpdate(rows);
      setRows(rows);
  ...
  const CustomPagination = () => {
    ...
    return (
      <TablePagination
        ...
        sx={{
          color: styles.dataGridTheme.color,
          "& .Mui-disabled": {
            color: `${styles.dataGridTheme.disabledIconColor} !important`,
          },
          "& .MuiSelect-icon": {
            color: styles.dataGridTheme.color,
          },
      ...
      <div style={{ width: "100%", padding: "0% 2%" }}>
        ...
        {selectedRow ? (
          ...
          <DataGrid
            ...
            sx={{
              backgroundColor: styles.dataGridTheme.bgColor,
              borderRadius: "2px",
              width: "100%",
              marginTop: "20px",
              marginBottom: "20px",
